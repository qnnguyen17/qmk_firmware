...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_CAPS, KC_LGUI, KC_LALT,                   KC_SPC,                             KC_RALT, MO(2),   KC_APP,  KC_RCTL,            KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [1] = LAYOUT(
        ...
        KC_TRNS, KC_LALT, KC_LGUI,                   KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,            KC_TRNS, KC_TRNS, KC_TRNS \
    ),
    [2] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS,  L_T_ONF, KC_TRNS, KC_TRNS, MD_BOOT, TG_NKRO, TG(1),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                              KC_TRNS, \
